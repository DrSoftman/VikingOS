...
## This Makefile was copied and adjusted from the Makefile in Wickslynx's GitHub repo: "https://github.com/Wickslynx/AuroraOS".
## So I give him all the cred for making this very good Makefile. 

## This Makefile has a lot of things that need to be changed later when I have made and completed my C/C++ source files, 
## I have mainly only adjusted it so that it currently only should to compile the ASM code in "kernel/boot/".
