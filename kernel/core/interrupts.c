// This file is borrowed from Wickslynx/AuroraOS. I am probably going to adjust it accordingly to my needs in the future if I ever need to, like a lot of other files I borrow from him.
// All cred goes to him.
